...
class CommentService
{
    ...
    public function listForArticle(int $articleId)
    {
        try {
            ...
            Log::error('comment.list.fail', ['article_id' => $articleId]);

            throw new ApiException('Yorumlar alınamadı', 500);
        }
    }
    ...
    public function setStatus(int $id, string $status)
    {
        ...
        try {
            ...
            Log::error('comment.status.fail');

            throw new ApiException('Yorum güncellenemedi', 500);
        }
    }
