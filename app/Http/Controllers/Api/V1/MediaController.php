...
use App\Http\Requests\Api\V1\Media\UploadCoverRequest;
use App\Http\Requests\Api\V1\Media\UploadGalleryRequest;
...
class MediaController extends Controller
{
    ...
    public function uploadCover(int $id, UploadCoverRequest $r)
    {
        ...
        abort_if(! in_array($f->getMimeType(), ['image/jpeg', 'image/png', 'image/webp'], true), 422, 'Desteklenmeyen format');
